...
1.  **Clonar:** `git clone https://github.com/jorgelopez21/labs.git`
2.  **Abrir:** Simplemente abre el archivo `index.html` en tu navegador.
...
Las contribuciones son bienvenidas vía Pull Requests.
